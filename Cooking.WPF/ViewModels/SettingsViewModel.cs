...
public class SettingsViewModel
{
    ...
    private void OnSelectedAppThemeChanged()
    {
        if (SelectedAppTheme != null)
        {
            ...
            options.Theme = SelectedAppTheme.BaseColorScheme;
            settingsService.UpdateAppSettings(options);
        }
    }
    ...
    {
        options.ShowLastWeekSuggestion = ShowLastWeekSuggestion;
        settingsService.UpdateAppSettings(options);
    }

    private void ChangeCulture()
    {
        options.Culture = localization.CurrentCulture.Name;
        settingsService.UpdateAppSettings(options);
