...
/// </summary>
[InjectValidation]
public class IngredientEditViewModel : OkCancelViewModel
{
    ...
    private List<string> AllIngredientNames { get; }
    ...
    protected override async Task OkAsync()
    {
        if (NameChanged
         ...
         && AllIngredientNames.Any(x => string.Equals(x, Ingredient.Name, StringComparison.OrdinalIgnoreCase)))
        {
