...
public class DayService : CRUDService<Day>, IDayService
{
    ...
    public void InitCache()
    {
        ...
        var allDaysCooked = context.Set<Day>()
    ...
    public DateTime? GetLastCookedDate(Guid recipeID)
    {
        ...
        DateTime? date = context.Set<Day>().Where(x => (x.DinnerID == recipeID || x.DinnerGarnishID == recipeID) && x.DinnerWasCooked)
    ...
    public async Task<List<Day>?> GetWeekAsync(DateTime weekday)
    {
        ...
        List<Day> weekDays = await context.Set<Day>()
                                       .Include(x => x.Dinner)
...
#pragma warning disable CS8602, CS8604
        var days = context.Set<Day>().Include(x => x.Dinner)
...
#pragma warning restore CS8602, CS8604
    ...
    public async Task DeleteWeekAsync(DateTime weekday)
    {
        ...
        using CookingContext context = ContextFactory.Create();
        IEnumerable<Day> days = context.Set<Day>()
                                    .AsNoTracking()
