...
public class CookingContext : DbContext
{
    ...
    public CookingContext(string dbFilename, string culture)
    {
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (DbFilename != null)
        {
            optionsBuilder.UseSqlite($"Data Source={Path.Combine(AppDomain.CurrentDomain.BaseDirectory, DbFilename)}");
        }
    ...
    {
        modelBuilder.ApplyGlobalFilters<Entity>(e => e.Culture == culture);
